...
| 类型   | 包含的名称                                                                                                                                   | 描述 |
|------|-----------------------------------------------------------------------------------------------------------------------------------------|-------------|
| 人行道  | `Road_Sidewalk` 或 `Roads_Sidewalk`                                                                                                      | 行人可以自由地在这些网格上行走。 |
...
__4.__ 将 `<mapName>.obj` 和 `<mapName>.xodr` 移动到 [`Util/DockerUtils/dist`](https://github.com/OpenHUTB/hutb/tree/hutb/Util/DockerUtils/dist) 。
